...
- M10 Narrative Mission Layer is open. M10-1 defines the PRD/test contract, M10-2 adds machine-readable mission/world/capability schemas and fixtures, M10-3 rejects decorative missions, and M10-4 proves one text-first narrative mission records the same Speaking Skill OS evidence as plain `today`.
