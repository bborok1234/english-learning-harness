...
- M9 Real Learner Pilot Bridge is open. M9-1 adds owner/self pilot state and command surface without assuming a personal name.
...
- [ ] M9-3: Add learner-facing pilot prompts and privacy handoff (#138).
