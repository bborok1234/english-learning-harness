...
- `pilot-day` now records the day's mission, scene, asset deck, next asset action, learner report, cockpit, session artifact, and friction note.
- `pilot-finish` now writes `product_journey_audit` into the pilot report.
- Pilot Markdown reports now show asset deck paths, next asset ids, evidence completeness, friction-note count, and the product decision.
...
- each day preserves mission, scene, asset deck, top asset action, learner report, and cockpit links;
